...
# Sesión 3 — Puente H: control de motores DC y servomotor
...
![Control de servomotor con Arduino](1789712113519_image.png)
*Servomotor conectado y controlado mediante señal PWM desde el Arduino UNO.*
